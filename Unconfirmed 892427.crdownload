...
class MFService:
    ...
    def fetch_navs(self):
        try:
            ...
            self.nav_data = pd.DataFrame(data)
    ...
    def search(self, query):
        ...
        if self.nav_data is not None:
            matches = self.nav_data[self.nav_data["name"].str.contains(query, case=False, na=False)]
...
if __name__ == "__main__":
    print("=" * 50)
    print("🚀 AAHAVAN AI AGENT - CLOUD VERSION")
    print("=" * 50)
